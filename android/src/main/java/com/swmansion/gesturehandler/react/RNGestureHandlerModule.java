...
public class RNGestureHandlerModule extends ReactContextBaseJavaModule {
  ...
  private static final String KEY_PAN_FAIL_SLOPE = "failSlope";
  ...
  private static class PanGestureHandlerFactory extends HandlerFactory<PanGestureHandler> {
    ...
    public void configure(PanGestureHandler handler, ReadableMap config) {
      ...
      if(config.hasKey(KAY_PAN_FAIL_SLOPE)) {
        handler.setFailSlope(PixelUtil.toPixelFromDIP(config.getDouble(KEY_PAN_FAIL_SLOPE)));
      }
